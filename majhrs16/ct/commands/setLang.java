    ...
    try {
      ...
      switch (args.length) {
        ...
        case 2:
          ...
          lang = args[1];
          this.api.checkSupportLang(lang, "&7El idioma &f'&b%lang%&f' &cno &7esta &csoportado&f!.");
      ...
      this.api.checkSupportLang(config.getString("default-lang"), "&7El idioma por defecto &f'&b%lang%&f' &cno esta soportado&f!.");
