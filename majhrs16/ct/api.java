...
public class api {
  ...
  public void broadcast(CommandSender sender, String msgFormat, String msg, String sourceLang) {
    ...
    sendMessage(null, (CommandSender)Bukkit.getConsoleSender(), msgFormat, msg, sourceLang);
    for (Player player2 : Bukkit.getOnlinePlayers())
      sendMessage(sender, (CommandSender)player2, msgFormat, msg, sourceLang); 
  }
  ...
  public String formatMsg(CommandSender playerFrom, CommandSender playerTo, String msgFormat, String msg, String sourceLang, String targetLang) {
    if (playerFrom instanceof Player && this.util.checkPAPI().booleanValue() && this.util.IF("auto-format-messages") && playerFrom != null) {
    ...
    if (playerTo instanceof Player && this.util.checkPAPI().booleanValue() && playerTo != null) {
  ...
  public String getLang(CommandSender sender) {
    ...
    String path = "";
    UUID UUID = this.util.getUUID(sender);
